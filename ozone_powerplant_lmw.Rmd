...
## Read in Georgia's Replication Data from Dataverse 
```{r}
...
png("images/balancing_mod1.jpeg", height = 2000, width = 1500, res = 300)
plot(summary(lmw.out1))
dev.off()
png("images/balancing_mod2.jpeg", height = 2000, width = 1500, res = 300)
plot(summary(lmw.out2))
dev.off()
png("images/balancing_mod3.jpeg", height = 2000, width = 1500, res = 300)
plot(summary(lmw.out3))
dev.off()

png("images/influencedist_mod1.jpeg", height = 1000, width = 700, res = 200)
plot(lmw.out1, type = "influence", outcome = mean4maxOzone)
dev.off()
png("images/influencedist_mod2.jpeg", height = 1000, width = 700, res = 200)
plot(lmw.out2, type = "influence", outcome = mean4maxOzone)
dev.off()
png("images/influencedist_mod3.jpeg", height = 1000, width = 700, res = 200)
...
png("images/mod1.jpeg", height = 2000, width = 2000, res = 200)
...
gs[[1]] = ggplot() +
  ...
  scale_color_gradient2(midpoint=0, low="blue", mid="white",
                     high="red", space ="Lab" ) + 
  geom_sf_text(data = dat_sf, aes(label=ifelse(weights>0.025,Name,''))) + 
  labs(title = 'All Covariates + Spatial Spline (df = 10)')
...
png("images/mod2.jpeg", height = 2000, width = 2000, res = 200)
grid.arrange(grobs = gs, nrow = 2)
dev.off()
```
...
gs[[1]] = ggplot() +
  ...
  scale_color_gradient2(midpoint=0, low="blue", mid="white",
                     high="red", space ="Lab" ) + 
  geom_sf_text(data = dat_sf, aes(label=ifelse(weights>0.025,Name,''))) + 
  labs(title = 'Spatial Spline (df = 10)')
...
png("images/mod3.jpeg", height = 2000, width = 2000, res = 200)
grid.arrange(grobs = gs, nrow = 2)
dev.off()
```
